...
>(({ children, visuallyHidden, className, ...props }, ref) => {
    const description = (
        <RUIDialog.Description
            ...
            className={clsx(
                className,
                "text-center text-base text-black/80 dark:text-white/80",
            )}
            {...props}
        >
            {children}
                        ...
                        >
                            <RUIDialog.Content asChild forceMount>
                                <animated.div
                                    ...
                                    className={clsx(
                                        className,
                                        "pointer-events-auto relative flex h-fit max-h-full w-full flex-col gap-2 rounded-md bg-gray-100 p-4 shadow-lg dark:bg-gray-800",
                                    )}
                                    {...props}
                                    style={{
                                        ...style,
